...
public final class UseCollection {   
    ...
    public static void main(final String... s) {
    	...
    	int primo = array.get(0);
    	array.set(0, array.size()-1);
    	array.set(array.size()-1, primo);
         ...
         */
          ...
          System.out.println("Converting " + ELEMS
                  + " int to String and inserting them in Array took " + time
                  + "ns (" + time / TO_MS + "ms)");
          ...
          time = System.nanoTime() - time;
          System.out.println("Converting " + ELEMS
                  + " int to String and inserting them in Linked took " + time
                  + "ns (" + time / TO_MS + "ms)");
        /*
         ...
         */
           ...
           */
          time = System.nanoTime() - time;
          System.out.println("Converting " + 1000
                  + " int to String and inserting them in Array took " + time
                  + "ns (" + time / TO_MS + "ms)");
